...
class DailyViewWidgetRemoteViewsFactory(val context: Context, val intent: Intent): RemoteViewsService.RemoteViewsFactory {
    ...
    private var scheduleSettings = Constants.dummyScheduleSettings
    private var schedule = Constants.dummySchedule
    private var scheduleTiming = Constants.dummyScheduleTiming
    ...
    override fun onDataSetChanged() {
        scheduleSettings = Constants.dummyScheduleSettings
        schedule = Constants.dummySchedule
        scheduleTiming = Constants.dummyScheduleTiming
    }
